<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateStatus.aspx.cs" Inherits="Advising114.Admin.UpdateStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  Updated Successfully!
            ...
            <asp:GridView ID="GridView1" CssClass=" table-danger m-3"  runat="server"  BorderColor="#999999" BorderStyle="Groove" BorderWidth="1px"  CellPadding="3" ForeColor="Black" GridLines="Vertical" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="81%" EmptyDataText="Null" ShowFooter="True" AutoGenerateColumns="False" >
...
<FooterStyle BorderColor="#FF9999" ForeColor="#FF9966"></FooterStyle>
                ...
                <asp:CommandField ControlStyle-CssClass="btn btn-success rounded-pill" ControlStyle-BorderStyle="None" SelectText="Update" ButtonType="Button"     ShowSelectButton="True" >
