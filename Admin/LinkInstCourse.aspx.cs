...
{
    public partial class LinkInstCourse : System.Web.UI.Page
    {
        ...
        protected DataTable Courses()
        {
            ...
            //cmd.Parameters.AddWithValue("@student_id", 1);
            con.Open();
        ...
        protected void Proc(int slotID, int courseID, int InstructorID)
        {
            SqlConnection con = new SqlConnection(connStr);
        ...
        {
            GridViewRow SlotRow = GridView5.SelectedRow;
            int SlotId = Convert.ToInt32(SlotRow.Cells[0].Text);
            GridViewRow CourseRow = GridView1.SelectedRow;
            int CourseId = Convert.ToInt32(CourseRow.Cells[0].Text);
            GridViewRow InstructorRow = GridView2.SelectedRow;
            int InstructorId = Convert.ToInt32(InstructorRow.Cells[0].Text);

            Proc(SlotId, CourseId, InstructorId);
