<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="CertainSlots.aspx.cs" Inherits="Advising114.Student.CertainSlots" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <RowStyle  HorizontalAlign="Center"/>
            ...
            <div  style="margin-bottom:500px">
                ...
                <asp:GridView ID="GridView5" style="margin-left:400px"   runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
                    <AlternatingRowStyle BackColor="#CCCCCC" />
                    <Columns>
                        ...
                        <asp:BoundField DataField="Instructor" HeaderText="Name" />
                    </Columns>
                    <FooterStyle BackColor="#CCCCCC" />
                    <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
            ...
            <asp:GridView ID="GridView2"  style="margin-left:900px;margin-bottom:600px; margin-top:-370px " runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Width="425px" Height="131px" HorizontalAlign="Center" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
    <AlternatingRowStyle BackColor="#CCCCCC" />
    <Columns>
        <asp:BoundField DataField="instructor_id" HeaderText="Instructor ID" />
